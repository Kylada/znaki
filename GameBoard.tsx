...
export const GameBoard: React.FC = () => {
  // FIX #3: Use acceptTie and cancelTie instead of raw setGameStatus for tie actions.
  // acceptTie has a proper guard preventing accepting your own proposal.
  const { players, localPlayerId, gameStatus, setGameStatus, resetGame, tieProposedBy, acceptTie, cancelTie } = useGameStore();
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-400 text-sm">
                ...
                {gameStatus === 'tie-proposed' && tieProposedBy === localPlayerId
                  ? 'Вы предложили ничью. Ожидание ответа оппонента...'
                  : 'Оппонент предложил закончить игру вничью.'}
            ...
            <div className="flex flex-col gap-3">
              {gameStatus === 'tie-proposed' && (
                <button 
                  ...
                  // FIX #3: Route through acceptTie which guards against self-acceptance
              ...
              {gameStatus === 'tie-proposed' && (
                <button 
                  ...
                  // FIX #3: Use cancelTie to also reset tieProposedBy
                  onClick={() => cancelTie()}
                >
                  Отменить
                </button>
